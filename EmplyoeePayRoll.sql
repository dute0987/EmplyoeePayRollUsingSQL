...
--UC3
insert into employee_payroll values (101,'Vishal Dute','52000','2022/01/01'),
(304,'Tushar Dute','58000','2021/05/14');
...
update employee_payroll set gender='M' where name='Bill' or name='Vishal Dute' or name='Tushar Dute';
...
--UC10
 into employee_pinsertayroll values
...
INSERT INTO employee VALUES ('Vishal',986926455,'Sewri Mumbai','M','2019/02/15',(SELECT CompanyID FROM Company WHERE CompanyName='Amazon'));
INSERT INTO employee VALUES ('Tushar','828241418','Khar Mumbai','M','2017/01/28',(Select CompanyID from Company where CompanyName='Microsoft'));
...
SELECT * FROM employee WHERE EmployeeName='Tushar';
